...
#    is_balanced=True
#    s=Stack()
#    if paren_string == '': # handle the case of ''
#        is_balanced=False
#        return False
#    elif paren_string[-1] in '([{': # cases like '((', '{{', '[[[[' will be handled by this
#        is_balanced=False
#        return False
#    else: 
#        while index<len(paren_string) and is_balanced==True:
...
#                s.push(paren_string[index])
#            else: 
#                if s.is_empty(): # case of '())', or '))', or the .pop operation is done
#                    is_balanced=False
#                    return False
#                elif is_match(s.pop(), paren_string[index]):
#                    is_balanced=True
